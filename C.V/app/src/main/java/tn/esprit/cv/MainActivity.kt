...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var androidSb : SeekBar;
    private lateinit var iosSb : SeekBar;
    private lateinit var flutterSb : SeekBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameEt=findViewById(R.id.et_name); ageEt=findViewById(R.id.et_age);
        emailEt=findViewById(R.id.et_email)
        genderRg=findViewById(R.id.rg_gender);
        maleRb=findViewById(R.id.rb_male);
        femaleRb=findViewById(R.id.rb_female)
        androidSb=findViewById(R.id.sb_android);
        iosSb=findViewById(R.id.sb_ios);
        flutterSb=findViewById(R.id.sb_flutter)
